  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        Course to Curriculum Mapping Editing
      </div>
      <div class="panel-body">
        <div class="row">
          <div class="col-lg-6">
          <form action="/CourseCurriculumMapping/{{ $mapping->CourseCurriculumMappingID }}" method="post">
            @method('PUT')
              <table border="0">
                <tr>
                    ...
                    <div class="form-group">
                      <select class="form-control" name="CurriculumID" required>
                        @foreach ($curriculums as $curriculum):
                          @if($curriculum->CurriculumID == $mapping->CurriculumID)
                    ...
                    <div class="form-group">
                      <select class="form-control" name="CourseID" required>
                        @foreach ($courses as $course):
                          @if($course->CourseID == $mapping->CourseID)
                ...
                <tr>
                  ...
                  <td><div class="form-group"><input class="form-control" type="text" name="SemesterNumber" value={{$mapping->SemesterNumber}} required></div></td>
                </tr>
