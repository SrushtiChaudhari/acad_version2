            ...
            @method('PUT')
              <table border="0">
                <tr>
                    ...
                    <td><div class="form-group"><input type="text" class="form-control" name="CurriculumCode" value={{ $curriculum->CurriculumCode }} required></div></td>
                </tr>
                <tr>
		                <td><label for="TotalCredits">Total Credits:</label></td>
                    <td><div class="form-group"><input type="number" class="form-control" name="TotalCredits" value={{ $curriculum->TotalCredits }} required></div></td>
                </tr>
